...
public class SVNBranchTagWizard extends Wizard {
    private IResource[] resources;
    private ISVNRemoteResource[] remoteResources;
    private SVNBranchTagWizardRepositoryPage repositoryPage;
    private SVNBranchTagWizardCopyPage copyPage;
    private SVNBranchTagWizardCommentPage commentPage;
	...
	public SVNBranchTagWizard(IResource[] resources) {
		super();
		this.resources = resources;
		setWindowTitle(Policy.bind("BranchTagDialog.title")); //$NON-NLS-1$
	}
	
	public SVNBranchTagWizard(ISVNRemoteResource[] remoteResources) {
		super();
	...
	public void addPages() {
		repositoryPage = new SVNBranchTagWizardRepositoryPage();
		addPage(repositoryPage);
		copyPage = new SVNBranchTagWizardCopyPage();
		copyPage.setRevisionNumber(revisionNumber);
		addPage(copyPage);
		commentPage = new SVNBranchTagWizardCommentPage();
		addPage(commentPage);
	}
