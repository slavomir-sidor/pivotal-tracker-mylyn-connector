...
public class MoveBefore implements IDynamicSubMenuContributor {
  ...
  public MenuManager getSubMenuManager(final List<IRepositoryElement> selectedElements) {
    final MenuManager subMenuManager = new MenuManager("Move Before");
  ...
  private void moveBefore(String targetStoryId) {

    try {
      String response = pivotalTracker.moveStory(selectedTask.getTaskId(), targetStoryId, "before");
