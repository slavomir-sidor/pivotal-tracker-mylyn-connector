...
public class SVNBranchTagWizardRepositoryPage extends SVNWizardPage {
	...
	public SVNBranchTagWizardRepositoryPage() {
	...
	public void createControl(Composite parent) {
		resources = ((SVNBranchTagWizard)getWizard()).getResources();
		remoteResources = ((SVNBranchTagWizard)getWizard()).getRemoteResources();
...
//		else toUrlCombo.setText(urls[0].toString());
		//toUrlCombo.setText(BranchAction.svnUrl);
